...
<template>
  <UModal
    ...
    description="Define qué usuarios pueden prestar este servicio en cada sucursal disponible."
    ...
    <template #body>
      <div class="space-y-4">
        <AdminFormSection
          ...
          description="Asigna personal elegible por sucursal para operar el servicio."
          :columns="1"
        >
          <div
          ...
          >
            <div class="mb-3">
              ...
              <p class="text-sm text-slate-500 dark:text-slate-400">
                {{ branch.address || branch.code || "Sin dirección registrada" }}
              </p>
            </div>
