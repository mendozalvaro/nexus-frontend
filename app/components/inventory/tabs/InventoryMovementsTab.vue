...
import InventoryMovementTable from "@/components/inventory/InventoryMovementTable.vue";
import type { InventoryHistoryData, InventoryMovementRowView } from "@/utils/inventory";
