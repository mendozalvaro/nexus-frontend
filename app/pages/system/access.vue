...
const PLAN_PRESETS: Record<PlanPresetKey, PlanPreset> = {
  starter: {
    ...
    permissions: [
      ...
      { key: "catalog.products", enabled: true },
      { key: "clients", enabled: true },
      { key: "pos.sales", enabled: true },
      { key: "reports.sales", enabled: true },
  ...
  growth: {
    ...
    permissions: [
      { key: "dashboard", enabled: true },
      { key: "catalog.products", enabled: true },
      { key: "catalog.services", enabled: true },
      { key: "clients", enabled: true },
      { key: "pos.sales", enabled: true },
      { key: "reports.sales", enabled: true },
      { key: "reports.services", enabled: true },
      { key: "users", enabled: true },
      { key: "inventory", enabled: true },
      { key: "appointments", enabled: true },
      { key: "service_assignment", enabled: true },
      { key: "reservations", enabled: false },
  ...
  enterprise: {
    ...
    permissions: [
      ...
      { key: "catalog.products", enabled: true },
      { key: "catalog.services", enabled: true },
      { key: "catalog.rooms", enabled: true },
      { key: "clients", enabled: true },
      { key: "pos.sales", enabled: true },
      { key: "reports.sales", enabled: true },
      { key: "reports.services", enabled: true },
      { key: "reports.lodging", enabled: true },
      { key: "users", enabled: true },
      { key: "inventory", enabled: true },
      { key: "appointments", enabled: true },
      { key: "service_assignment", enabled: true },
      { key: "branches", enabled: true },
      { key: "reservations", enabled: true },
      { key: "settings", enabled: true },
    ],
    limits: [
